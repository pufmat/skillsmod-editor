...
<script lang="ts" context="module">
	...
	export interface State {
		...
		newConnections: editor.Connection[];
	}
</script>
	...
	{#if state !== null}
		<Padding padding="16px">
			<VStack gap="16px">
				<VStack>
					<Text>
						Following skills are missing in the editor, but are required by some connections in the loaded connections file:
						<ul>
						...
						Continuing to load this connections file will ignore all connections which use these missing skills.
					</Text>
				</VStack>
				<HStack gap="8px">
					<Spacer />
