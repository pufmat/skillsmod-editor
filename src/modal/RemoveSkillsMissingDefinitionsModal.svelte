...
<script lang="ts" context="module">
	...
	export interface State {
		...
		newDefinitions: editor.Definition[];
	}
</script>
	...
	{#if state !== null}
		<Padding padding="16px">
			<VStack gap="16px">
				<VStack>
					<Text>
						Following definitions are missing in the loaded definitions file, but are required by some skills in the editor:
						<ul>
						...
						Continuing to load this definitions file will remove all skills which use these missing definitions.
					</Text>
				</VStack>
				<HStack gap="8px">
					<Spacer />
